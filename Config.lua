...
function ns.UpdateActiveState()
    ...
    if statusIndicator then
        if active then
            statusIndicator:SetText("|cff00ff00Active|r - Bar " .. (DominosHoldToCastFixDB and DominosHoldToCastFixDB.bar or "?"))
        else
            local db = DominosHoldToCastFixDB
...
local function CreateConfigPanel()
    ...
    -- Bar dropdown
    local barDropdown = CreateFrame("Frame", "DominosHoldToCastFixBarDropdown", frame, "UIDropDownMenuTemplate")
    ...
    applyBtn:SetScript("OnClick", function()
        ns.HoldToCastFix:ApplyBindings()
        print("|cff00ff00DominosHoldToCastFix:|r Settings applied - Bar " .. db.bar .. " routed to Blizzard buttons")
    end)
